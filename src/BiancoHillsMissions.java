public class BiancoHillsMissions {
    public static Mission[] makeBiancoHillsMissions() {
       ...
       // Mission coinsOfTheLake = new Mission("Test", Mission.Objectives.collectShine, Main.createBiancoHills(new Player(new Point(18, 57, 2), null)));
        Mission coinsOfTheLake = new Mission("Test", Mission.Objectives.collectShine, Main.createBiancoHills(new Player(new Point(19, 10, 2), null)));

        Mission coinsOfTheLake2 = new Mission("Test one", Mission.Objectives.collectShine, Main.createBiancoHills(new Player(new Point(30, 30, 1), null)));
