public class BiancoHillsMissions {
    public static Mission[] makeBiancoHillsMissions() {
        ...
        Mission coinsOfTheLake = new Mission("The Hillside Secret", Mission.Objectives.collectShine, Main.createBiancoHillsMission3(new Player(new Point(71, 13, 2), null)));
